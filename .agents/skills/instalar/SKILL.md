...
### `AGENTS.md`
Pegar o template correspondente ao perfil escolhido na Fase 1 (`templates/perfis/Codex-md-<perfil>.md`), adaptar com o nome do negócio e estrutura de pastas mencionada nas respostas, e sobrescrever o `AGENTS.md` da raiz.
