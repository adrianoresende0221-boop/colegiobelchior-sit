...
description: >
  ...
  skills concretas e cria as aprovadas em `.Codex/skills/`. Use quando o usuário pedir
...
1. Criar pasta `.Codex/skills/<nome>/`
...
```
Criei [N] skills:
✓ /<nome1> — em .Codex/skills/<nome1>/SKILL.md
✓ /<nome2> — em .Codex/skills/<nome2>/SKILL.md
...
