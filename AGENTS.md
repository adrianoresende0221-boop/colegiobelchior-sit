...
operação do MazyOS — como o Codex lê o contexto, aprende com correções,
...
em `.Codex/skills/`. Se encontrar, seguir as instruções da skill. Se
...
2. Perguntar se é específica desse projeto ou útil em qualquer:
   - Específica → `.Codex/skills/nome-da-skill/SKILL.md` (local)
   - Universal → `~/.Codex/skills/nome-da-skill/SKILL.md` (global)
3. Ler `_memoria/empresa.md` e `_memoria/preferencias.md` pra calibrar
   o conteúdo da skill ao contexto do negócio
4. Se a skill precisar de arquivos de apoio (templates, exemplos),
   criar dentro da pasta da skill
5. Seguir o fluxo da skill-creator nativa do Codex
